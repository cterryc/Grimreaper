export const englishListItemsBis = {
  // Head: {
  //   'Broken Ram Skull Helm': {
  //     class: ['Warr Prot', 'DK Blood Tank', 'Pala Prot'],
  //     id: '50640',
  //     img: 'https://wow.zamimg.com/images/wow/icons/large/inv_helmet_151.jpg'
  //   }
  // },
  Neck: {
...
export const spanishListItemsBis = {
  // Head: {
  ...
  Cape: {
    ...
    'Gran capa de campeón converso': ['Druid Rest'],
    'Maña de Vereesa': ['Rogue', 'Hunter', 'Warr Fury'],
    ...
    'Capa de destripador de La Cámara de las Sombras': ['Pala Ret', 'Druid Cat']
  },
  Chest: {
    'Saco de maravillas de Ikfirus': ['Rogue', 'Druid Bear'],
    'Toga de la pesadilla despierta': ['Mage'],
    'Toga de seda sanguina': ['Druid Rest']
  },
  Wrist: {
    'Brazales de noche ígnea': [
      'Rshamy',
      'Shadow P',
      'Warlock',
      'Mage',
    ...
    'Brazales de cambio de fase': ['Hpala', 'Druid Rest', 'Druid Balance'],
    'Guardamuñecas máximos de Toskk': ['Rogue', 'Warr Fury'],
    'Avambrazos de cazador de la Plaga': ['Hunter'],
  ...
  Hands: {
    ...
    "Guantes de acechador Anub'ar": ['Pala Ret']
  },
  Waist: {
    'Cinturón de forma partida': ['Rshamy', 'Hpala'],
    'Cincho suturado de Astrylian': [
      'Rogue',
      'Pala Ret',
      'Druid Cat',
      'Druid Bear'
    ],
    "Cordón de acechador Nerub'ar": ['Hunter'],
    'Cinturón de geliespectro aplastante': [
      'Shadow P',
      'Disci',
      'Warlock',
      'Mage',
  ...
  Legs: {
    'Leotardos gangrenosos': ['Rogue'],
    'Leotardos de luces del norte': ['Hunter'],
    ...
    'Quijotes de atracador de la Plaga': ['Warr Fury', 'Dk Uh'],
  ...
  Feet: {
    ...
    'Botas de crecimiento antinatural': ['Druid Rest'],
    'Botas de pelaje congeladas': ['Rogue', 'Druid Cat', 'Druid Bear'],
    'Pisadas de regreso': ['Hunter'],
  ...
  Ring: {
    ...
    'Anillo de zafiro Razaescarcha': ['Rogue', 'Hunter', 'Warr Fury'],
    'Sello de crepúsculo': ['Pala Ret', 'Feral Cat'],
    'Poderío de añublo': ['Dk Uh']
  },
  Trinket: {
    ...
    'Consuelo de los caídos': ['Rshamy'],
    'Testamento del Libramorte': [
      'Rogue',
      'Druid Cat',
      'Hunter',
      'Warr Fury',
    ...
    'Filacteria del exánime innombrable': [
      'Shadow P',
      'Warlock',
      'Mage',
      'Druid Balance'
    ...
    'Ábaco de Althor': ['Disci', 'Druid Rest'],
    'Cristal de meteorito': ['Hpala']
  },
  Weapon: {
    ...
    'Baluarte de acero incandescente': ['Rshamy', 'Hpala'],
    "Oleada de sangre, hoja de agonía de Kel'Thuzad": [
      'Warlock',
      'Mage',
      'Hpala'
    ],
    'Llamada del caos, hoja de los Reyes de Lordaeron': ['Rogue'],
    'Hacha de guerra de vástagos de la Plaga': ['Rogue'],
    'Vinculador de juramentos, carga del general forestal': [
      'Hunter',
      'Pala Ret',
      'Druid Cat',
      'Druid Bear'
